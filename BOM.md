...
Since we dont wanna wait for shipping and have issues with it (prolly hack club too) ataisenberg have found everything we need locally with prices and pls give us more than my friend put here we might burn something T_T. We are ppl too we make mistakes T_T (me koshuub remade the list so that it includes spare parts and he actually missed some part so ye)

So we gonn 3d print it i think my friend fixed his 3d printer so we can print it with 1.75 PLA filament and the prices will be in both currencies both USD and SOM (which is our Kyrgyz currency) and the rate of them is approximately 1 USD ~ 87 SOM without any other fees or taxes ig. And ye i think most of the stuff is cheap ig? idunno

And the lst wasnt made by me (koshuub) it was made by my friend(ataisenberg) so idunno what things he added


ESP32-S3 N16R8 Dev Board (16MB Flash / 8MB PSRAM) — 2 pcs — 1,320 KGS ($15.20 USD) — Source: KnowHow.kg (Includes 1 spare)

OV2640 Camera Module with Ribbon Cable — 2 pcs — 780 KGS ($9.00 USD) — Source: KnowHow.kg / Geek.kg (Includes 1 spare)

N20 Micro Gear Motors 6V — 4 pcs — 1,200 KGS total ($14.00 USD) — Source: Geek.kg / KnowHow.kg (Includes 2 spares)

Mini Tank Rubber Tracks Set with 3mm D-shaft Drive Wheels — 1 set — 740 KGS ($8.50 USD) — Source: Geek.kg

TB6612FNG Dual DC Motor Driver Module — 2 pcs — 600 KGS ($7.00 USD) — Source: KnowHow.kg (Includes 1 spare)

1.69 inch ST7789 SPI TFT Color Display Module — 1 pcs — 430 KGS ($5.00 USD) — Source: Geek.kg

MAX98357 I2S Audio Amplifier Module + 3W Speaker — 1 pcs — 350 KGS ($4.00 USD) — Source: KnowHow.kg

SG90 Micro Servo Motors — 4 pcs — 700 KGS total ($8.00 USD) — Source: KnowHow.kg / Geek.kg (Includes 2 spares)
